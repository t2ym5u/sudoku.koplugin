...
function SudokuBoardWidget:init()
    ...
    do
        ...
        local mini = cell / 3
        local padding = math.max(1, math.floor(mini / 12))
        local max_w = math.max(1, math.floor(mini - 2 * padding))
        local max_h = math.max(1, math.floor(mini - 2 * padding))
